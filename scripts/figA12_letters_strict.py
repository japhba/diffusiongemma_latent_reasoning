"""Fig A12: worst-case (strict) parallelism triptych vs n, letters (case-flip) only.

Same cells as fig2b, but aggregated min-over-targets vs max-over-non-targets: the report's
'strict duplicate' — positive E^min only if EVERY target beats EVERY reference letter.
...
fig.savefig(OUT / "figA12_letters_strict.png", dpi=200)
print(OUT / "figA12_letters_strict.png")
